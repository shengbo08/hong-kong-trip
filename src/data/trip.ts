...
export const trip: TripData = {
  ...
  days: [
    ...
    },
    {
      ...
      date: '2026-09-02',
      city: '中環、上環、太平山與港島夜景',
      highlights: ['中環半山手扶梯', '大館', '太平山頂', '叮叮車'],
      activities: [
        {
          id: 'd2-a1',
          time: '上午',
          place: '中環半山手扶梯、蘇豪、上環',
          activity: '從中環一路散步到上環，拍街景、逛小店，可安排早午餐或咖啡。',
          googleMapsUrl: maps('Central Mid-Levels Escalator Hong Kong'),
          transport: '港鐵中環站',
        },
        {
          id: 'd2-a2',
          time: '中午',
          place: '大館、PMQ 元創方',
          activity: '看歷史建築與設計選物，行程節奏比商場更舒服。',
          googleMapsUrl: maps('Tai Kwun Hong Kong'),
          estimatedCost: { amount: 0, currency: 'HKD' },
        },
        {
          id: 'd2-a3',
          time: '下午',
          place: '港島叮叮車',
          activity: '搭電車慢慢穿過港島街區，可從中環往銅鑼灣或北角方向體驗。',
          googleMapsUrl: maps('Hong Kong Tramways Central'),
          transport: '香港電車',
          estimatedCost: { amount: 3, currency: 'HKD' },
        },
        {
          id: 'd2-a4',
          time: '傍晚到晚上',
          place: '太平山頂',
          activity: '看香港經典天際線。若山頂纜車排隊太久，可改搭巴士或的士上山。',
          googleMapsUrl: maps('Victoria Peak Hong Kong'),
          transport: '山頂纜車 / 15 號巴士 / 的士',
          estimatedCost: { amount: 108, currency: 'HKD' },
          note: '凌霄閣觀景台票價與纜車套票會變動，出發前再確認。',
        },
      ],
    },
    {
  ...
  accommodations: [
    {
      ...
      price: { amount: 9000, currency: 'TWD' },
  ...
  budget: [
    { id: 'flight-ticket', category: 'flight', label: '來回機票', cost: { amount: 13000, currency: 'TWD' }, note: '暫估，依航班確認後調整' },
    { id: 'stay', category: 'accommodation', label: '2 晚住宿', cost: { amount: 9000, currency: 'TWD' }, note: '以市區雙人房估算' },
