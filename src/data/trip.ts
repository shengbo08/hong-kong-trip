...
export const trip: TripData = {
  ...
  budget: [
    { id: 'flight-ticket', category: 'flight', label: '機票', cost: { amount: 8000, currency: 'TWD' }, note: '高雄 - 香港來回機票' },
    { id: 'stay', category: 'accommodation', label: '住宿', cost: { amount: 2000, currency: 'TWD' }, note: '三天兩夜住宿' },
    { id: 'local-transport', category: 'transport', label: '交通', cost: { amount: 1000, currency: 'TWD' }, note: '八達通卡、地鐵、巴士、電車（叮叮車）、渡輪及計程車' },
    { id: 'disneyland', category: 'ticket', label: '門票', cost: { amount: 3000, currency: 'TWD' }, note: '香港迪士尼門票、山頂纜車' },
    { id: 'food', category: 'food', label: '餐飲', cost: { amount: 4000, currency: 'TWD' }, note: '菠蘿油、絲襪奶茶、雲吞麵、腸粉' },
    { id: 'shopping', category: 'other', label: '其他', cost: { amount: 1000, currency: 'TWD' }, note: '' },
  ],
  importantInfo: {
    passportVisa:
